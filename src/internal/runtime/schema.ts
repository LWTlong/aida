/**
 * Internal runtime schema for MCP bookkeeping and legacy compatibility.
 *
 * 2.0 product truth sources live in `.aida/*.json`.
 * This schema remains only for internal runtime flows that are still supported.
 */
